...
public class Agenda_04_Persistencia {
    ...
    public void insertAgenda_04(Agenda_04 oAgenda_04) {
        ...
        try (Connection connection = ConexaoMySql.conectaBD();
            ...
            callableStatement.setDate(5, oAgenda_04.getA04_data_limite()); // Use setDate para java.sql.Date
            ...
            callableStatement.setDate(9, oAgenda_04.getA04_dt_cadastro()); // Use setDate para java.sql.Date
            callableStatement.setDate(10, oAgenda_04.getA04_dt_ultima_alteracao()); // Use setDate para java.sql.Date
    ...
    public void updateAgenda_04(Agenda_04 oAgenda_04) {
        ...
        try (Connection connection = ConexaoMySql.conectaBD();
            ...
            callableStatement.setDate(4, oAgenda_04.getA04_data_limite()); // Use setDate para java.sql.Date
            ...
            callableStatement.setDate(8, oAgenda_04.getA04_dt_ultima_alteracao()); // Use setDate para java.sql.Date
    ...
    public Agenda_04 selectAgenda_04(int a04_codigo) {
        ...
        try (Connection connection = ConexaoMySql.conectaBD();
            ...
            if (rs.next()) {
                ...
                oAgenda_04.setA04_data_limite(rs.getDate("A04_DATA_LIMITE")); // Use getDate para java.sql.Date
                ...
                oAgenda_04.setA04_dt_cadastro(rs.getDate("A04_DT_CADASTRO")); // Use getDate para java.sql.Date
                oAgenda_04.setA04_dt_ultima_alteracao(rs.getDate("A04_DT_ULTIMA_ALTERACAO")); // Use getDate para
                                                                                              // java.sql.Date
