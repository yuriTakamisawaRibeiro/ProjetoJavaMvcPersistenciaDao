...
public class Usuario_02_Dao {
    ...
    public void createProcedureAltUsuario(Connection connection) throws SQLException {
        String createProcedureSQL = "CREATE PROCEDURE IF NOT EXISTS PROC_ALTUSUARIO_02(A02_CODIGO INT, A02_NOME TEXT, A02_USUARIO TEXT, A02_SENHA TEXT, A02_CODIGO_LINK TEXT, A02_EMAIL TEXT, A02_STATUS TINYINT, A02_DT_CADASTRO DATE, A02_DT_ULTIMA_ALTERACAO DATE) "
                + "BEGIN "
                + "UPDATE USUARIO_02 "
